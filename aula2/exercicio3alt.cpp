...
void Conta ::inicializaConta(char *nome, int numero, float saldo)
{
...
void Conta ::debitarConta(float valor)
{
    saldo -= valor;
}

void Conta ::creditarConta(float valor)
{
    saldo += valor;
}

void transferirValorConta(int saldoRecebe, int saldoTransfere, float valor)
{
}
